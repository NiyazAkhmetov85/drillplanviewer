...
// Широта: 53° 24' 47,53" C  ~ 53.41320278°
const LAT_0_DECIMAL = 53.41320278; 
// Долгота: 69° 14' 18,99" B  ~ 69.23860833°
...
const FALSE_EASTING = 4458.9140;      [cite_start]// Δx (Ложный Восток) [cite: 18]
const FALSE_NORTHING = 7317.3475;     [cite_start]// Δy (Ложный Север) [cite: 18]
...
// B. USLOVWGS - Локальная система, аппроксимированная Поперечным Меркатором
// Это наиболее подходящий стандартный тип проекции для локальных прямоугольных систем.
